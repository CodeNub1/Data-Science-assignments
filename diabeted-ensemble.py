...
#importing dataset
df=pd.read_csv('C:/Users/Sidha/OneDrive/Desktop/Datasets/Ensemble/Diabeted_Ensemble.csv')
df.columns
...
df[' Class variable'] = labelencoder.fit_transform(df[' Class variable'])
